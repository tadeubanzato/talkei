...
class TweetListener(tweepy.StreamListener):
    ...
    def on_status(self, tweet):
        ...
        minions =[tweet.id,tweet.user.screen_name,tweet.user.friends_count]#,'Followers':[tweet.user.followers_count],'Created':[tweet.user.created_at],'Location':[tweet.user.location],'Tweet':[tweet.text]})
